...
mysql -uroot -pdclxvi -e "GRANT ALL ON *.* TO 'root'@'%' IDENTIFIED BY 'dclxvi' WITH GRANT OPTION;CREATE DATABASE `SimpleDatabase`;CREATE USER 'remmie' IDENTIFIED BY 'nemA_666';GRANT USAGE ON *.* TO 'remmie'@'%' IDENTIFIED BY 'nemA_666';FLUSH PRIVILEGES"
